...
void substraction()
{
    ...
    time_taken3 = (double)(end_time - begin_time) / (double) CLOCKS_PER_SEC;
    printf("Elapsed time of 1,000,000 substraction operations that use"
            "loop unrolling: %f seconds \n", time_taken3);
...
void multiplication()
{
    ...
    time_taken3 = (double)(end_time - begin_time) / (double) CLOCKS_PER_SEC;
    printf("Elapsed time of 1,000,000 multiplication operations that use"
           " loop unrolling: %f seconds \n", time_taken3);
...
void division()
{
    ...
    time_taken3 = (double)(end_time - begin_time) / (double) CLOCKS_PER_SEC;
    printf("Elapsed time of 1,000,000 division operations that uses"
           " loop unrolling: %G seconds \n", time_taken3);
...
void power()
{
    ...
    time_taken3 = (double)(end_time - begin_time) / (double) CLOCKS_PER_SEC;
    printf("Elapsed time of 1,000,000 power operations that uses "
            "loop unrolling: %f seconds \n", time_taken3);
...
void squareroot(){
    ...
    printf("Elapsed time of 1,000,000 squareroot operations: %f seconds \n", time_taken2);
    ...
    time_taken3 = (double)(end_time - begin_time) / (double) CLOCKS_PER_SEC;
    printf("Elapsed time of 1,000,000 squareroot operations that uses "
            "loop unrolling: %f seconds \n", time_taken3);
